...
function getDraftSecret() {
	return "7acdbae7-35df-4e34-8757-d491965e7c5a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e68b9fa7-c43b-468e-93f6-73b63aa370f1";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e68b9fa7-c43b-468e-93f6-73b63aa370f1") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e68b9fa7-c43b-468e-93f6-73b63aa370f1",
		rootBoundaryId
	});
}
/**
